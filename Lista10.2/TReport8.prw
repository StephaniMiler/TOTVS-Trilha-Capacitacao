...
Static Function GeraReport()
	...
	TRCell():New(oSection2, 'C6_PROD', 'SC6', 'Código do Produto', /*Picture*/, 15, /*Pixel*/, /*Code-Block*/, 'LEFT', .T., 'LEFT', /*Comp.*/,/*Espac. Entre Cel.*/, .T., /*Cor Fundo*/, /**Cor Fonte*/, .T.)
...
Static Function Imprime(oReport, cAlias)
	...
	while !(cAlias)->(EoF())
		...
		cPedAnterior := ((cAlias)->(C5_NUM))

        

		oSection2:Cell('C6_ITEM'):SetValue((cAlias)->C6_ITEM)
        oSection2:Cell('C6_PROD'):SetValue((cAlias)->C6_PRODUTO)
