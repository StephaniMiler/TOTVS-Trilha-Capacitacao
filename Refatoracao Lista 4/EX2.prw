...
#INCLUDE 'PROTHEUS.CH'
#DEFINE TITULO_TELA 'Insira a cotação do dólar e a quantidade em U$:'

/*/{Protheus.doc} User Function ConversorMoeda
    Converte valor do Dólar para Real
    @type  Function
    @author Stephani Miler
    @since 13/03/2023
/*/

User Function ConversorMoeda()
    ...
    DEFINE MSDIALOG oDlg TITLE TITULO_TELA FROM 000, 000 TO 120, 400 PIXEL
