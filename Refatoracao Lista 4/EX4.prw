...
#INCLUDE 'PROTHEUS.CH'
#DEFINE TITULO_TELA 'Cálculo área'

/*/{Protheus.doc} User Function AreaParede
    Calcula a área de uma parede e a quantidade de tinta para pintá-la
    @type  Function
    @author Stephani Miler
    @since 13/03/2023
/*/
User Function AreaParede()
