...
#INCLUDE 'PROTHEUS.CH'
#DEFINE TITULO_TELA 'Cálculo Taxa Metabólica Basal'

/*/{Protheus.doc} User Function CalculaTMB
    Calcula TMB de homens e mulheres
    @type  Function
...
User Function CalculoTMB()
    ...
    DEFINE MSDIALOG oDlg TITLE TITULO_TELA FROM 000, 000 TO 100, 700 PIXEL
